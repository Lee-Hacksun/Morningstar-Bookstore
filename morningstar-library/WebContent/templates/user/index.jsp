    ...
    <div id="content" class="mb-auto p-4 h-auto pt-28 pb-40">
        <div id="upper_banner" class="mx-auto mt-5 max-w-[1300px] px-4 sm:px-6 lg:px-8 text-center">
            <div id="default-carousel" class="relative mt-5" data-carousel="slide">
                <!-- 홍보 배너 -->
                <div class="relative h-96 flex justify-center items-center inset-0 shadow-md overflow-hidden">
                    <!-- Item 1 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="https://image.yes24.com/images/00_Event/2024/0417Kids/Big_PC(959x421)_C4.jpg"
                             class="absolute block w-full items-center -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                             alt="...">
                    </div>
                    <!-- Item 2 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="https://image.yes24.com/images/00_Event/2024/0320Be/Big_PC(959x421)_C4.jpg"
                             class="absolute block w-full items-center -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                             alt="...">
                    </div>
                    <!-- Item 3 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="https://image.yes24.com/images/00_Event/2024/0321Fill/Big_PC(959x421)_C4.jpg"
                             class="absolute block w-full items-center -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                             alt="...">
                    </div>
                    <!-- Item 4 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="https://image.yes24.com/images/00_Event/2024/0422Original/Big_PC(959x421)_C4.jpg"
                             class="absolute block w-full items-center -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                             alt="...">
                    </div>
                    <!-- Item 5 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="https://image.yes24.com/images/00_Event/2024/0415Wsb/bn_959x421.jpg"
                             class="absolute block w-full items-center -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                             alt="...">
                    </div>
                </div>
                <!-- Slider indicators -->
                <div class="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-3 rtl:space-x-reverse mb-2">
