            ...
            <div class="justify-items-end w-full p-4">
                <div class="grid grid-cols-4 gap-4">
                    ...
                    <div class="float-left">
                        <div>
                            <a href="/products/366">
                                <img src="https://contents.kyobobook.co.kr/sih/fit-in/300x0/pdt/9791193262122.jpg"
                                     alt="book cover">
                            </a>
                            <div>
                                <a href="/products/">
                    ...
                    <div class="float-left">
                        <div>
                            <a href="/products/348">
                                <img src="https://contents.kyobobook.co.kr/sih/fit-in/300x0/pdt/9791171830237.jpg"
                                     alt="book cover">
                            </a>
                            <div>
                                <a href="/products/">
                    ...
                    <div class="float-left">
                        <div>
                            <a href="/products/354">
                                <img src="https://contents.kyobobook.co.kr/sih/fit-in/300x0/pdt/9791170611080.jpg"
                                     alt="book cover">
                            </a>
                            <div>
                                <a href="/products/">
                                    <div class="flex flex-col p-3">
                                        ...
                                        <div class="mt-1">
                                            <p class="text-left text-base">tvn
                                                <벌거벗은세계사>제작팀 · 교보문고
                                            </p>
                                        </div>
                                    </div>
