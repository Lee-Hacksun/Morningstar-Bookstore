...
<div class="flex flex-col h-screen justify-between">
    <%@include file ="../assets/header/admin_header.jsp" %>
                            ...
                            <tr class="hidden flex-1 overflow-x-auto w-full" id="table-column-body-0" aria-labelledby="table-column-header-0">
                                <td class="p-4 border-b" colspan="9">
                                    ...
                                    <div class="flex items-center justify-end space-x-3 mt-4">
                                        <button onclick="delet_user()" type="button" class="py-2 px-3 flex items-center text-sm font-medium text-center text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 rounded-lg dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                                            탈퇴
                                        </button>
                                    </div>
                                </td>
...
<script src="../assets/script/admin_script.jsp"></script>
</html>